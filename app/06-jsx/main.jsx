...
console.log('e1', e1);
ReactDOM.render(e1, document.getElementById('root1'));
...
console.log('e3', e3);
// raise a warning.
ReactDOM.render(e3, document.getElementById('root3'));

// 4) Better should use parenthesis for wrapping multiline JSX
// this is ok
const e4 = <div className="hello">Coucou !</div>;
console.log('e4', e4);
ReactDOM.render(e4, document.getElementById('root4'));
...
function getE4_2() {
  return <div className="hello">Coucou !</div>;
}
console.log('e4.2', getE4_2());

// 5) Always use an enclosing tag. (error)
// const e5 = <span>hello</span><span>world</span>;
const e5 = <span><span>hello</span><span>world</span></span>;
ReactDOM.render(e5, document.getElementById('root5'));
...
ReactDOM.render(e6, document.getElementById('root6'));
...
ReactDOM.render(e7, document.getElementById('root7'));

// 8) Self closing tag are permitted.
const e8 = <div />;
console.log('e8', e8);

ReactDOM.render(e8, document.getElementById('root8'));
...
console.log('e9', e9);
ReactDOM.render(e9, document.getElementById('root9'));
...
const e10 = <div {...props} />;
console.log('e10', e10);
ReactDOM.render(e10, document.getElementById('root10'));

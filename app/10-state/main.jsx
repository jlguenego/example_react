...
class ProgressiveWrite extends React.Component {
  ...
  // called when the component just after it is attached to the DOM.
  componentDidMount() {
    console.log('mount component');
    this.timerID = setInterval(this.tick.bind(this), 300);
  }

  // called when the component is about to be detached from the DOM.
  ...
  render() {
    ...
    const result = (
      <div className='hello' style={style}>
        &nbsp;{this.props.text.substring(0, this.state.length)}
      </div>
    );
    return result;
  }
